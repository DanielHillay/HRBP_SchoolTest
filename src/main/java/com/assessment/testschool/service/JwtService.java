...
import com.assessment.testschool.entity.LoginResponse;
...
import com.assessment.testschool.util.JwtUtil;
...
public class JwtService implements UserDetailsService {
    ...
    public ResponseEntity<StandardResponse> createJwtToken(LoginRequest jwtRequest) throws Exception {
        ...
        return StandardResponse.sendHttpResponse(true, "Operation was successful",
                new LoginResponse(user,newGeneratedToken), "200");
    }
